    ...
    if (password) {
      if (!isValidPassword(password)) {
        return res.status(400).send({
          status: false,
          message:
          "Password should be strong, please use one number, one uppercase letter, one lowercase letter, and one special character. Password should be between 8 to 15 characters long!",
        });
      }
